...
public class SizeBasedInliningRegressionTests
{
    ...
    public void ParseToFile_compiles_to_valid_function_with_inlining()
    {
        ...
        // parseToFile is non-recursive (a top-level parser entry point that
        // delegates to other parsers but does not call itself). After Approach
        // A1 (always emit WithEnvFunctions), it is wrapped uniformly in the
        // WithEnvFunctions shape regardless of recursion.
