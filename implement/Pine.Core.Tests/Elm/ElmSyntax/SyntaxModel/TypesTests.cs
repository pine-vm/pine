...
public class TypesTests
{
    ...
    public void Exposing_All_value_equality()
    {
        ...
        var exposing1 = new Exposing.All(range1);
        var exposing2 = new Exposing.All(range2);
    ...
    {
        var expose1 = new TopLevelExpose.FunctionExpose("myFunction");
        var expose2 = new TopLevelExpose.FunctionExpose("myFunction");
    ...
    {
        var expose1 = new TopLevelExpose.InfixExpose("+");
        var expose2 = new TopLevelExpose.InfixExpose("+");
    ...
    public void ExposedType_value_equality()
    {
        ...
        var type1 = new ExposedType("Maybe", range);
        var type2 = new ExposedType("Maybe", range);
    ...
    {
        var type1 = new TypeAnnotation.Unit();
        var type2 = new TypeAnnotation.Unit();
    ...
    {
        var pattern1 = new Pattern.AllPattern();
        var pattern2 = new Pattern.AllPattern();
    ...
    public void Pattern_TuplePattern_value_equality()
    {
        ...
        var elemNode = new Node<Pattern>(range, new Pattern.VarPattern("x"));
        var elements = new SeparatedSyntaxList<Node<Pattern>>.NonEmpty(elemNode, []);

        var pattern1 = new Pattern.TuplePattern(elements);
        var pattern2 = new Pattern.TuplePattern(elements);
    ...
    public void Pattern_ListPattern_value_equality()
    {
        ...
        var pattern1 = new Pattern.ListPattern(elements);
        var pattern2 = new Pattern.ListPattern(elements);
    ...
    public void Pattern_RecordPattern_value_equality()
    {
        ...
        var fields = new SeparatedSyntaxList<Node<string>>.NonEmpty(fieldNode, []);

        var pattern1 = new Pattern.RecordPattern(fields);
        var pattern2 = new Pattern.RecordPattern(fields);
