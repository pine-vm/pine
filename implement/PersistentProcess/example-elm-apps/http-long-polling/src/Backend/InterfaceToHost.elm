...
ProcessResponseStructure with field: notifyWhenArrivedAtTime : Maybe { posixTimeMilli : Int }

-}
type ProcessRequest
    = CompleteHttpResponse HttpResponseRequest
    | StartTask StartTaskStructure
    | NotifyWhenArrivedAtTimeRequest { posixTimeMilli : Int }
...
decodeProcessEvent =
    Json.Decode.oneOf
        ...
        , Json.Decode.field "taskComplete" decodeTaskComplete |> Json.Decode.map TaskComplete
...
encodeProcessRequest request =
    case request of
        ...
        NotifyWhenArrivedAtTimeRequest { posixTimeMilli } ->
            Json.Encode.object
                [ ( "NotifyWhenArrivedAtTimeRequest"
                  , [ ( "posixTimeMilli", posixTimeMilli |> Json.Encode.int ) ] |> Json.Encode.object
                  )
                ]
