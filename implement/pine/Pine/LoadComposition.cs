...
public static class LoadComposition
{
        ...
        return
            ...
            .MapResult(
                sourcePath =>
                {
                    try
                    {
                        var treeComponentFromSource =
                            LoadFromLocalFilesystem.LoadSortedTreeFromPath(
                                sourcePath,
                        ...
                        {
                            return
                                Result<string, FileTree>.err(
                                    "I did not find a file or directory at '" + sourcePath + "'.");
                        }
    ...
    public static IEnumerable<string> LogEntriesForLoadFromGitSuccess(
        LoadFromGitHubOrGitLab.LoadFromUrlSuccess loadFromGitSuccess)
    {
    ...
    public static ProcessWithLog<string, T> AsProcessWithStringLog<T>(T result) =>
