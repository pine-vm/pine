...
downloads =
    { linux = "https://github.com/pine-vm/pine/releases/download/v0.3.27/pine-bin-v0.3.27-linux-x64.zip"
    , windows = "https://github.com/pine-vm/pine/releases/download/v0.3.27/pine-bin-v0.3.27-win-x64.zip"
    , macOS = "https://github.com/pine-vm/pine/releases/download/v0.3.27/pine-bin-v0.3.27-osx-x64.zip"
    }
