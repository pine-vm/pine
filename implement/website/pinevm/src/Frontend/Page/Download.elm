...
downloads =
    { linux = "https://github.com/pine-vm/pine/releases/download/v0.5.0/pine-bin-v0.5.0-linux-x64.zip"
    , windows = "https://github.com/pine-vm/pine/releases/download/v0.5.0/pine-bin-v0.5.0-win-x64.zip"
    , macOS = "https://github.com/pine-vm/pine/releases/download/v0.5.0/pine-bin-v0.5.0-osx-x64.zip"
    }
