...
downloads =
    { linux = "https://github.com/pine-vm/pine/releases/download/v0.4.34/pine-bin-v0.4.34-linux-x64.zip"
    , windows = "https://github.com/pine-vm/pine/releases/download/v0.4.34/pine-bin-v0.4.34-win-x64.zip"
    , macOS = "https://github.com/pine-vm/pine/releases/download/v0.4.34/pine-bin-v0.4.34-osx-x64.zip"
    }
