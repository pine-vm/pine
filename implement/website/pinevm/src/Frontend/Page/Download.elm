...
downloads =
    ...
    , windows = "https://github.com/pine-vm/pine/releases/download/v0.3.28/pine-bin-v0.3.28-win-x64.zip"
    , macOS = "https://github.com/pine-vm/pine/releases/download/v0.3.28/pine-bin-v0.3.28-osx-x64.zip"
    }
