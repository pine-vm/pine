...
public class ParseElmModuleTextToPineValueTests
{
    ...
    static readonly ElmCompilerCache s_elmCompilerCache = new();
        ...
        Core.PineVM.IPineVM pineVM)
    {
        ...
        responseAsExpression.Should().Be(
            ...
            because: "Module parsed as expression syntax");
