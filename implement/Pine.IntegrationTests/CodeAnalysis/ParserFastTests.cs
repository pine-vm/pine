...
public class ParserFastTests
{
    ...
    public void ParserFast_benchmark_allPattern()
    {
        ...
        invocationReports.Count.Should().BeLessThan(5);

        instructionCount.Should().BeLessThan(160);
    }
}
