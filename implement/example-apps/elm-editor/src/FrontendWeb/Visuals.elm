...
iconSvgElementFromIcon { color } iconType =
    ...
    in
    Svg.svg
        [ Svg.Attributes.viewBox ([ 0, 0, iconSvg.width, iconSvg.height ] |> List.map String.fromInt |> String.join " ")
...
iconSvgPathsData : Icon -> { width : Int, height : Int, paths : List { pathData : String, fillNone : Bool } }
