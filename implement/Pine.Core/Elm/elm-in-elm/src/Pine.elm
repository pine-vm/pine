    ...
    case bytes of
        byte :: rest ->
            ...
            hexadecimalStringFromBlobValue
                (String.fromList
                    [ hexadecimalCharacterFromInt upperNibble
                    , hexadecimalCharacterFromInt (byte - (upperNibble * 16))
                    ]
                    :: acc
                )
                rest
...
hexadecimalCharacterFromInt : Int -> Char
hexadecimalCharacterFromInt int =
    case int of
        0 ->
            '0'
