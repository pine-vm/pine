...
public class NameMapper
{
        ...
        var mapped =
            typeAnnotNode.Value switch
            {
                ...
                new TypeAnnotation.Tupled(
                    TypeAnnotations:
                    MapSeparatedList(tupled.TypeAnnotations, t => MapTypeAnnotation(t, mapQualifiedName))),
    ...
    private static Node<ExpressionSyntax.LetDeclaration> MapLetDeclaration(
        ...
        Func<QualifiedNameRef, QualifiedNameRef> mapQualifiedName)
    {
        ExpressionSyntax.LetDeclaration mappedDecl =
            declNode.Value switch
            {
        ...
        Func<QualifiedNameRef, QualifiedNameRef> mapQualifiedName)
    {
        return
            new RecordExprField(
                ...
                MapExpression(field.ValueExpr, mapQualifiedName));
    }
