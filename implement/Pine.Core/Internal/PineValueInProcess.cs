...
public class PineValueInProcess
{
    ...
    public static PineValueInProcess CreateFullyRepresented(PineValue evaluated)
    {
        if (evaluated is PineValue.ListValue listValue)
        {
            ...
            {
                items[i] = CreateWithDerivedRepresentations(sourceItems[i]);
            }
        ...
        return CreateWithDerivedRepresentations(evaluated);
    }

    private static PineValueInProcess CreateWithDerivedRepresentations(PineValue evaluated)
    {
