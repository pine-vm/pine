...
/// For conversion between the generic value type and common data types, see <see cref="IntegerEncoding"/>, <see cref="StringEncoding"/>, and <see cref="FileTreeEncoding"/>.
/// <para/>
...
public abstract record PineValue : IEquatable<PineValue>
{
    ...
    public static ListValue List(ReadOnlyMemory<PineValue> items)
    {
         ...
         * 
         * Expand condition for sparsity, to reduce costs in interning.
         * */
        if (newInstance.MaxDepth % 4 is 0)
        {
            if (newInstance.NodesCount * 30 + newInstance.BlobsBytesCount > 10_000)
            {
    ...
    public record ListValue : PineValue, IEquatable<ListValue>
    {
        ...
        /// <summary>
        /// Maximum depth found in the tree. For an empty list, this depth has value 1.
        /// </summary>
